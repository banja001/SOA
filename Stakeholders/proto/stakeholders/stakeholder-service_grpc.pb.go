...
const (
	...
	StakeholderService_ValidateAccessToken_FullMethodName = "/StakeholderService/ValidateAccessToken"
)
...
func (c *stakeholderServiceClient) ValidateAccessToken(ctx context.Context, in *AccessToken, opts ...grpc.CallOption) (*TokenClaims, error) {
	out := new(TokenClaims)
	err := c.cc.Invoke(ctx, StakeholderService_ValidateAccessToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStakeholderServiceServer) ValidateAccessToken(context.Context, *AccessToken) (*TokenClaims, error) {
...
func _StakeholderService_ValidateAccessToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccessToken)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StakeholderServiceServer).ValidateAccessToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StakeholderService_ValidateAccessToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StakeholderServiceServer).ValidateAccessToken(ctx, req.(*AccessToken))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StakeholderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StakeholderService_ValidateAccessToken_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "stakeholders/stakeholder-service.proto",
}
